...
<body>
    ...
    <main class="dashboard-container">
        ...
        <!-- Header reso responsivo con flex-wrap e gap -->
            ...
            <div class="dash-table-wrapper">
                <table class="dash-table">
                    ...
                    <tbody>
                        ...
                        %>
                        <tr>
                            <!-- Aggiunto data-label a ogni TD -->
                            <td data-label="Nome"><strong><%= u.getNome() %> <%= u.getCognome() %></strong></td>
                            <td data-label="Email"><%= u.getEmail() %></td>
                            <td data-label="Data Nascita"><%= (u.getDataNascita() != null) ? u.getDataNascita().toString() : "N/D" %></td>
                            ...
                            <td data-label="Azioni" style="text-align: right; gap: 8px; display: flex; justify-content: flex-end; flex-wrap: wrap;">
                                <% if(!u.getTipo().equals("admin")) { %>
                                    ...
                                    <% } %>
                                        <a href="GestioneUtentiServlet?azione=elimina&email=<%= u.getEmail() %>" class="btn-action btn-ban" onclick="return confirm('Sei sicuro di voler eliminare questo utente? L\'azione è irreversibile.');">Elimina</a>                            
                                <% } else { %>
